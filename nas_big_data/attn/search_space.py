from nas_big_data.attn.multi_inputs_denseskipco import MultiInputsDenseSkipCoFactory

def create_search_space(
    input_shape=(6212,), output_shape=(1,), num_layers=5, regression=False, **kwargs
):
    return MultiInputsDenseSkipCoFactory()(
        input_shape, output_shape, num_layers=num_layers, regression=regression, **kwargs
    )

if __name__ == "__main__":
    shapes = dict(input_shape=(6212,), output_shape=(1,))
